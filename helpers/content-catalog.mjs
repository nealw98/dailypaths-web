...
export const ARTICLES = [
  ...
  { title: 'The Line I Kept Moving', path: '/articles/the-line-i-kept-moving/', image: 'articles/the-line-i-kept-moving/dinner-table-hero.webp', alt: 'Editorial illustration of an adult son and his mother at the dinner table', category: 'Personal story · Jeff J.', description: 'Learning to set boundaries with my mother—and to stop disappearing in the effort to earn her love.' },
];
