...
export const ARTICLES = [
  { title: 'Letting Go: Caring Without Carrying', path: '/topics/letting-go/', image: 'articles/letting-go-tightrope.webp', alt: 'A tightrope walker balances above a circus ring, viewed from overhead', category: 'Letting go', description: 'Recognizing what is yours to handle—and what you can begin to put down.' },
