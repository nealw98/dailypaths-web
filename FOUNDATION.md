...
All twelve monthly reflection pages now use smaller, two-column weekly lists with a brief editorial introduction, practical suggestion, and question. Links to the long Step articles were removed from those hubs; existing Step URLs remain available for historical links. A teaser-only reflections.xml feed is generated by the daily build for future email campaigns.
