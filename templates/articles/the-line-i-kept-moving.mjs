...
${photoHero({ image: bp('/assets/articles/the-line-i-kept-moving/dinner-table-hero.webp'), alt: 'Editorial illustration of an adult son and his mother seated across a dinner table, each with their own meal.', eyebrow: 'Personal story · Boundaries', title: STORY.title, subtitle: STORY.description, size: 'lg', titleClass: 'photo-hero-title--theme' })}
