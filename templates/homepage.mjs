  ...
  const bodyContent = `
    ...
    <section class="hm-hero">
      ...
      <div class="hm-hero-content">
        <h1 class="hm-hero-title">A Path of One&rsquo;s Own</h1>
    ...
    <section class="hm-engine bg-navy">
      <div class="hm-engine-inner">
        ...
        <div class="hm-engine-badges">
          ...
          <a href="https://play.google.com/store/apps/details?id=com.dailypaths" target="_blank" rel="noopener noreferrer" class="hm-engine-badge-link">
