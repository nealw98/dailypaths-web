...
<section class="ed-start" aria-labelledby="start-heading"><div class="ed-start-inner ed-wrap"><div><p class="ed-label">Start here</p><h2 id="start-heading">Is someone else&rsquo;s drinking affecting your life?</h2><p>See whether Al-Anon may be for you, what a meeting is like, and where you can begin.</p></div><a class="ed-button" href="${bp(IS_PREVIEW ? '/about-alanon/' : '/start/')}">${IS_PREVIEW ? 'Find help' : 'Start here'} <span aria-hidden="true">→</span></a></div></section>
