...
<section class="ed-start" aria-labelledby="start-heading"><div class="ed-start-inner ed-wrap"><div><p class="ed-label">Start here</p><h2 id="start-heading">Is someone else&rsquo;s drinking affecting your life?</h2><p>See whether Al-Anon may be for you, what a meeting is like, and where you can begin.</p></div><a class="ed-button" href="${bp('/start/')}">Start here <span aria-hidden="true">→</span></a></div></section>
    <section class="ed-articles ed-wrap" aria-labelledby="articles-heading"><div class="ed-section-heading"><h2 id="articles-heading">For the life you’re living</h2><a class="ed-link" href="${bp('/articles/')}">All articles</a></div><div class="ed-stories">${homepageStory(ARTICLES[0], 'editorial-doorway.webp')}${homepageStory(ARTICLES[1], 'editorial-phone.webp')}</div></section>
