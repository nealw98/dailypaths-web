...
export function renderHomePage(reading) {
  ...
  return wrapInLayout({
    ...
    <section class="ed-start" aria-labelledby="start-heading"><div class="ed-start-inner ed-wrap"><div><p class="ed-label">New to Al-Anon?</p><h2 id="start-heading">Start with what&rsquo;s happening to you.</h2><p>See whether Al-Anon may be for you, what a meeting is like, and where you can begin.</p></div><a class="ed-button" href="${bp('/start/')}">Start here <span aria-hidden="true">⟶</span></a></div></section>
